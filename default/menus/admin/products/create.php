                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="articlename" class="control-label">Product Name</label>
                            <div>
                                <input type="text" autocomplete="off" name="articlename" placeholder="Product Name" class="form-control" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <?php
                                  ...
                                  while($row2 = mysqli_fetch_assoc($getcat)) {
                                    ?>
                                    <option value="<?php echo htmlspecialchars($row2['idcategories']);?>"><?php echo htmlspecialchars($row2['catname']);?></option>
                                  <?php }
                                ;?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="priceperitem" class="control-label">Price</label>
                            <div>
                                <input type="text" autocomplete="off" name="priceperitem" placeholder="Price" class="form-control" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="articledesc" class="control-label">Description</label>
                            <div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $addarticle = "INSERT INTO products (productname, price, description, categorieid)"
            . "VALUES ('$articlename', '$priceperitem', '$description', '$category')";
